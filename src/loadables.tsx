...
// prettier-ignore
export const Library: LoadableComponent<any> = loadable(() => import('@src/containers/library'), { fallback });

// prettier-ignore
export const Book: LoadableComponent<any> = loadable(() => import('@containers/book'), { fallback });

// prettier-ignore
export const Chapter: LoadableComponent<any> = loadable(() => import('@containers/chapter'), { fallback });